...
class _$DashboardLoadedImpl implements DashboardLoaded {
  const _$DashboardLoadedImpl({
    ...
    required final List<EnrollmentEntity> enrollments,
  ...
  @override
  String toString() {
    return 'DashboardState.loaded(profile: $profile, enrollments: $enrollments, totalCourses: $totalCourses, completedCourses: $completedCourses, totalPoints: $totalPoints)';
  }
